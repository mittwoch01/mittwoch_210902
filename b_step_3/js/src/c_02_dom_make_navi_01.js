...
// 메뉴를 클릭하면, navigation영역이 나타나게 / 나타나 있으면 사라지게 한다.
// 1. 메뉴클릭 .navi_btn > button 클릭
// 2. navigation영역이 나타나게 > 그 부모인 .nav_area에 .on을 붙인다 (향후 수정 고려)
// 3. 만약 navigation영역이 나타나 있다면 반대로 사라지게 해라 > 그 부모인 .nav_area에 .on을 제거
