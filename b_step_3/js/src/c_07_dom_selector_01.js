...
// wrap.style은 한 줄로 쓰는 방법, 또는 역 슬래쉬(\)를 사용하는 방법
wrap.style = 'width:90%; margin:auto; \
              background-color:#fda; padding:0.5rem;';

// h1
var h1 = wrap.getElementsByTagName('h1')[0]; // getElement's'ByTagName은 복수형이라 배열형식으로 [순서]값을 지정해줘야함.
// console.log( h1 );
...
// var navArea2 = wrap.getElementsByTagName('nav')[0].getAttribute('nav_area');
// console.log( navArea2 );
navArea[0].style = 'width:100%;';

var navH2 = navArea[0].children[0];
navH2.classList.add('blind');
var navUl = navArea[0].children[1]; //.con_nav
navUl.style = 'display:flex;'

var navLi = navUl.chlidren;
console.log( navLi );
...
// --------------------------------------------------------------
var conBox = conBox.querySelector('')
