...
// 버튼클릭시 slide형식의 사라짐 기능과 토글기능
// setInterval, setTimeout을 이용한 랜덤 숫자배열 / color 매치
// 탭 메뉴 형식의 레이아웃 구성 > jQuery 코드 작성
// 과제 : 버튼 클릭시 모달윈도우 형식으로 페이드 구성처리 (opacity: block,0 > 100% / 100% > 0, none)
// 선택박스.slideDown(), 선택박스.slideUp(), 선택박스.slideTogle()
